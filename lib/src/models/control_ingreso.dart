class ControlIngreso {
  ...
  ControlIngreso.fromJsonMap(Map<String, dynamic> json) {
    rpta = json["rpta"];
...
class ControlIngresoUsuario {
  ...
  ControlIngresoUsuario.ControlIngresoUsuario({
    required this.id,
  ...
  factory ControlIngresoUsuario.fromJson(Map<String, dynamic> json) => ControlIngresoUsuario.ControlIngresoUsuario(
        id: json["id"],
