...
class ViajeDomicilioSincronizacionPage extends StatefulWidget {
  const ViajeDomicilioSincronizacionPage({Key? key}) : super(key: key);

  @override
  State<ViajeDomicilioSincronizacionPage> createState() =>
      _ViajeDomicilioSincronizacionPageState();
}

class _ViajeDomicilioSincronizacionPageState
    extends State<ViajeDomicilioSincronizacionPage> {
