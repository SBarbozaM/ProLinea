...
import 'package:embarques_tdp/src/pages/orden_servicio/lista_orden_servicio_taller_jefatura.dart';
...
class ScanUnidadOrdenServicioJefaturaPage extends StatefulWidget {
  const ScanUnidadOrdenServicioJefaturaPage({super.key});

  @override
  State<ScanUnidadOrdenServicioJefaturaPage> createState() => _ScanUnidadOrdenServicioJefaturaPageState();
}

class _ScanUnidadOrdenServicioJefaturaPageState extends State<ScanUnidadOrdenServicioJefaturaPage> {
  ...
  ValidarUnidad() async {
    ...
    await obtenerTaller();
    if (taller != null) {
      OsOrdenServicio requeResponse = await sOrden.ListaOrdenesServicio_Jefatura(Taller: taller!, Placa: textVehiculoController.text);
      Navigator.pop(context);
      ...
      if (requeResponse.rpta == '0') {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ListaOrdenServicioTallerJefatura(
