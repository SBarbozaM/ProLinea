...
class ControlSalidaLista extends StatefulWidget {
  const ControlSalidaLista({super.key});

  @override
  State<ControlSalidaLista> createState() => _ControlSalidaListaState();
}

class _ControlSalidaListaState extends State<ControlSalidaLista> {
  ...
  List<ControlSalidaUsuario> listaControlSalidaBase = [];
  ...
  ControlSalidaListar() async {
    ...
    listaControlSalida = await controladorServicio.ListarControlSalidasUsuario(
  ...
  Future<List<ControlSalidaUsuario>> BuscarControlNombre(String query) async {
  ...
  Future<List<ControlSalidaUsuario>> BuscarControlPlaca(String query) async {
    final newList = listaControlSalidaBase.where((control) {
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ControlSalidaUsuario csUsuario = listaControlSalida[index];
                  var conductor = "";
                  var unidad = "";
